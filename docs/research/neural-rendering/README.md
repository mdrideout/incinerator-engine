...
**Status:** Active research supporting accepted ADR-025; NR0-A through NR0-D
accepted, NR0-E through NR0-G open
...
4. [the NR0 plan](../../design/nr0-neural-rendering-feasibility.md) for the
