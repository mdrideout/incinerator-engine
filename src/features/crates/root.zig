...
const contract = @import("crate_contract");
...
const SpawnCrate = contract.SpawnCrate;
const ApplyImpulse = contract.ApplyImpulse;
const RelocateCrate = contract.RelocateCrate;
...
const CrateView = contract.CrateView;
const CrateDraw = contract.CrateDraw;
const Diagnostics = contract.Diagnostics;
const CrateV1 = contract.CrateV1;
