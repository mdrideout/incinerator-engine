...
const contract = @import("vehicle_contract");
...
const max_events = contract.max_events;
const VehicleTuning = contract.VehicleTuning;
const Config = contract.Config;
const VehicleTuningV1 = contract.VehicleTuningV1;
const VehicleConfigV1 = contract.VehicleConfigV1;
const SpawnVehicle = contract.SpawnVehicle;
const EnterVehicle = contract.EnterVehicle;
const DriveVehicle = contract.DriveVehicle;
const ExitVehicle = contract.ExitVehicle;
const AbandonVehicle = contract.AbandonVehicle;
const Command = contract.Command;
const CommandKind = contract.CommandKind;
const RejectionReason = contract.RejectionReason;
const CommandRejected = contract.CommandRejected;
const Outcome = contract.Outcome;
const Event = contract.Event;
const VehicleView = contract.VehicleView;
const WheelDraw = contract.WheelDraw;
const VehicleDraw = contract.VehicleDraw;
const Diagnostics = contract.Diagnostics;
const VehicleWheelV1 = contract.VehicleWheelV1;
const VehiclePoseV1 = contract.VehiclePoseV1;
const VehicleInputV1 = contract.VehicleInputV1;
const VehicleV1 = contract.VehicleV1;
const validateRecords = contract.validateRecords;
const validateRecord = contract.validateRecord;
