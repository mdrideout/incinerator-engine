...
const contract = @import("character_contract");
...
const CharacterConfigV1 = contract.CharacterConfigV1;
const SpawnCharacter = contract.SpawnCharacter;
const ApplyActions = contract.ApplyActions;
...
const CharacterView = contract.CharacterView;
const CharacterDraw = contract.CharacterDraw;
const Diagnostics = contract.Diagnostics;
const CharacterV1 = contract.CharacterV1;
