...
pub const Axis = projection_math.Axis;
const GizmoDragMapping = projection_math.GizmoDragMapping;
const ScreenProjection = projection_math.ScreenProjection;
const AxisProjection = projection_math.AxisProjection;
const projectAxis = projection_math.projectAxis;
const pointInsideInset = projection_math.pointInsideInset;
...
fn drawContentAsset(asset: *const engine.assets.Entry) void {
    ...
    switch (asset.details) {
        .lighting => zgui.text("Edit this asset in Lighting Lab", .{}),
