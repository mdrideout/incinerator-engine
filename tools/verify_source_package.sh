...
grep -Fxq 'src/features/vehicle/asset.zig' "$tmp/package-files"
grep -Fxq 'src/features/vehicle/presentation.zig' "$tmp/package-files"
grep -Fxq 'src/features/vehicle/steering.zig' "$tmp/package-files"
grep -Fxq 'src/hosts/vehicle_authoring.zig' "$tmp/package-files"
grep -Fxq 'src/hosts/vehicle_authoring_contract.zig' "$tmp/package-files"
grep -Fxq 'src/hosts/vehicle_developer_host.zig' "$tmp/package-files"
grep -Fxq 'src/editor/tools/vehicle_lab_tool.zig' "$tmp/package-files"
grep -Fxq 'src/vehicle_visual_resources.zig' "$tmp/package-files"
grep -Fxq 'game/vehicles/catalog.zig' "$tmp/package-files"
grep -Fxq 'game/vehicles/494e43494e455241-867ee4c3b011b0fe.icvehicle' "$tmp/package-files"
...
grep -Fxq 'game/industrial/population_catalog.zig' "$tmp/package-files"
...
grep -Fxq 'tools/gltf_to_glb.zig' "$tmp/package-files"
...
grep -Fxq 'game/assets/urban_building/urban_building.gltf' "$tmp/package-files"
grep -Fxq 'game/assets/urban_building/facade.png' "$tmp/package-files"
grep -Fxq 'game/assets/urban_building/PROVENANCE.md' "$tmp/package-files"
grep -Fxq 'game/assets/cargo_crate/cargo_crate.gltf' "$tmp/package-files"
grep -Fxq 'game/assets/cargo_crate/panels.jpg' "$tmp/package-files"
grep -Fxq 'game/assets/cargo_crate/PROVENANCE.md' "$tmp/package-files"
