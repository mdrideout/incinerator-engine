...
grep -Fxq 'src/hosts/sandbox_npc_replacement.zig' "$tmp/package-files"
grep -Fxq 'src/hosts/sandbox_npc_replacement_contract.zig' "$tmp/package-files"
...
grep -Fxq 'src/sandbox/product_encounter.zig' "$tmp/package-files"
...
grep -Fxq 'src/hosts/sandbox_product_encounter_test.zig' "$tmp/package-files"
...
(
  ...
  "$zig" build test-headless test-content test-content-cooker \
    ...
    test-npc-feature test-npc-encounter test-npc-replacement \
    test-population-contract test-vitals-feature test-physics \
    test-sandbox-value-contracts test-sandbox-controls \
    test-sandbox-product-encounter test-sandbox-product-encounter-host \
