...
grep -Fq 'network_options.addOption(u16, "protocol_revision", 18);' \
...
echo "INTERACTION_VALIDATION_AUDIT_PASS phases=6 human_trace=accepted docs=why-design-evidence scenario_catalog=shared fault_runner=seeded protocol=18 renderer_tint=reflected"
