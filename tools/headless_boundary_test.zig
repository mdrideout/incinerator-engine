...
const root_files = [_][]const u8{
    ...
    "src/hosts/simulation_snapshot.zig",
    "src/hosts/simulation_diagnostics.zig",
    "src/hosts/sandbox_host_contracts.zig",
    "src/hosts/sandbox_diagnostics_contract.zig",
    ...
    "src/session/authority_diagnostics.zig",
    "src/district_worker_contract.zig",
