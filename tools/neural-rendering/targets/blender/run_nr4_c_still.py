...
def main() -> None:
    ...
    atomic_json(
        run_manifest,
        {
            ...
            "status": "partial",
            "phase": "NR4-C-still",
            "purpose": "one native 160x90 Incinerator input paired with one direct native 400x225 rights-clean Cycles target",
    ...
    complete = {
        ...
        "status": "complete",
        "phase": "NR4-C-still",
        "review": "pending_human_native_160x90_to_400x225_still_review",
        "purpose": "one native 160x90 input paired only with one direct native 400x225 Cycles target",
        "working_resolution": {
            "input_extent": [160, 90],
        ...
        "evaluation": {
            ...
            "report": str((baseline_root / "native-160x90-to-400x225-review.png").relative_to(output)),
            "report_sha256": sha256_file(baseline_root / "native-160x90-to-400x225-review.png"),
        },
        "evidence_bytes": {
