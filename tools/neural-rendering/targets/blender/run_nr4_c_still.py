...
def main() -> None:
    ...
    atomic_json(
        run_manifest,
        {
            ...
            "status": "partial",
            "phase": "NR4-C-still",
            "purpose": "one native 160x90 Incinerator input paired with one direct native 640x360 rights-clean Cycles target",
    ...
    complete = {
        ...
        "status": "complete",
        "phase": "NR4-C-still",
        "review": "preapproved_native_160x90_to_640x360_still_review",
        "purpose": "one native 160x90 input paired only with one direct native 640x360 Cycles target",
        "working_resolution": {
            "input_extent": [160, 90],
        ...
        "evaluation": {
            ...
            "report": str((baseline_root / "native-160x90-to-640x360-review.png").relative_to(output)),
            "report_sha256": sha256_file(baseline_root / "native-160x90-to-640x360-review.png"),
        },
        "evidence_bytes": {
