...
const classified_sources = [_]ClassifiedSource{
    ...
    .{ .path = "src/content/lighting_library.zig", .owner = .engine_runtime },
    .{ .path = "src/engine/contracts/lighting.zig", .owner = .engine_runtime },
    .{ .path = "src/hosts/lighting_composition.zig", .owner = .game_runtime_content },
    .{ .path = "src/hosts/lighting_replay.zig", .owner = .game_runtime_content },
    .{ .path = "src/hosts/lighting_authoring_contract.zig", .owner = .engine_tooling },
    .{ .path = "src/hosts/lighting_authoring.zig", .owner = .engine_tooling },
    .{ .path = "src/hosts/lighting_developer_host.zig", .owner = .game_tooling, .boundary = .explicit_adapter },
    .{ .path = "src/editor/tools/lighting_lab_tool.zig", .owner = .game_tooling },
    .{ .path = "src/editor/gizmo_projection.zig", .owner = .game_tooling },
...
const named_owners = [_]NamedOwner{
    ...
    .{ .name = "lighting_authoring_contract", .owner = .engine_tooling },
    .{ .name = "lighting_authoring", .owner = .engine_tooling },
    .{ .name = "lighting_composition", .owner = .game_runtime_content },
